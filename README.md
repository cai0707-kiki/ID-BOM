...
### V2.1 (2026-09-24)
**VM选型表 & 系列表快速搜索 & ID新增配件**

- 新增VM选型表
- ID/SC系列表侧栏新增快速搜索：选中后跳转对应系列并滚动居中定位目标产品，整行橙色闪烁高亮
- 新增ID配件「条码验证器支架」（190437255）及图片、缩略图；关联ID5050XM系列4款条码验证器相机（可选搭配）
- 配置编辑器增强：ID/SC数据独立分桶切换、一键导出JS数据文件
