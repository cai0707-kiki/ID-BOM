...
- 新增「首页」模块导航页面，默认打开，展示四大功能入口卡片（配单表、对照表、系列表、PDA选型）
- 卡片点击跳转对应功能页面
...
- 调整配件系列编码，UV灯板通过系列区分焦距版本
- 同步更新 `Download/offline.html` 数据

### V1.4.1 (2026-09-01)
**离线版下载功能**

- 顶部栏新增「下载离线版」按钮，一键下载离线 HTML 文件
- 下载文件自动命名：`HIKROBOT-ID产品配单表` + 版本号 + 日期 + `.html`
- 版本号和日期自动从页面配置读取，无需手动修改
- 桌面端通过 fetch + Blob 下载并重命名；移动端跳转文件页面由用户自行保存
- 同步更新 `Download/offline.html` 公告与版本号
